...
function IndexPopup() {
  ...
  const buymeacoffeeClicked = function () {
    chrome.tabs.create({ url: 'https://next.jsj.top/f/Ah3ZWx' })
  }
    ...
    <Theme appearance="dark">
      <Container p="3" style={{ width: '280px', backgroundColor: 'var(--gray-a2)' }}>
        ...
        <Flex gap="4" direction="column" mt="4">
          <Text as="p" align="center" size="1" color="gray">
            B站黑暗模式观看体验。
          </Text>
          <Card>
              ...
              <Text as="label" size="2" align="center">
                <Flex align="center" gap="2">
                  <SegmentedControl.Root
                    ...
                    value={
                      darkBiliMode ||
                      (typeof darkBiliToggle === 'undefined' ? 'dark' : darkBiliToggle ? 'dark' : 'light')
                    }
